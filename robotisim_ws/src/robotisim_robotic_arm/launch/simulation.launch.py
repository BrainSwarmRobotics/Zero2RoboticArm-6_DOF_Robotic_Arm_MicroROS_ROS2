...
def generate_launch_description():
    ...
    package_name_gazebo = 'robotisim_robotic_arm'
    pkg_share_gazebo = FindPackageShare(package=package_name_gazebo).find(package_name_gazebo)
    default_robot_name = 'arm_v1'
    pkg_name = FindPackageShare(package="robotisim_robotic_arm").find("robotisim_robotic_arm")
    ...
    urdf_file_path = 'urdf/robotisim_robotic_arm.urdf.xacro'
    ...
    os.environ["IGN_GAZEBO_RESOURCE_PATH"] = os.path.join(
        "/home/muneeb/Desktop/robotisim_ws/src/bras_robot_description/models")

    os.environ["IGN_GAZEBO_RESOURCE_PATH"] = os.path.join(
        "/home/muneeb/Desktop/robotisim_ws/src/")
    ...
    robot_controllers = PathJoinSubstitution(
        [
            FindPackageShare('robotisim_robotic_arm'),
            'config',
            'robotisim_robotic_arm_controllers.yaml',
        ]
    )
